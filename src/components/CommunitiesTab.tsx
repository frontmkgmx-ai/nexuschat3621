...
export default function CommunitiesTab({ currentUser, onSelectConvo }: CommunitiesTabProps) {
  ...
  return (
    ...
    >
        <div className="pt-2 pb-3 px-5 shrink-0 flex items-end justify-between bg-[#111214]/90 backdrop-blur-md sticky top-0 z-10 border-b border-transparent">
            <h2 className="text-3xl font-display font-extrabold text-zinc-100 tracking-tight leading-none">Comunidades</h2>
            <button 
                onClick={() => setShowCreateMenu(true)}
                className="w-8 h-8 flex items-center justify-center bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 hover:text-indigo-300 rounded-full transition-colors focus:outline-none mb-0.5"
            >
