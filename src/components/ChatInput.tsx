...
export default function ChatInput({ 
  ...
  return (
    <div className="flex flex-col z-10 w-full shrink-0 border-t border-white/5 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
      ...
      <div className="bg-[#0a0a0c]/80 backdrop-blur-xl px-4 py-3 sm:py-4 flex items-center">
        ...
        <div className={`ml-2 sm:ml-3 flex items-center ${text.trim() ? "text-indigo-500" : "text-zinc-600"} transition-colors`}>
          {text.trim() ? (
            ...
            <div className="p-3.5 rounded-full bg-[#18181b] border border-white/5 text-zinc-600">
